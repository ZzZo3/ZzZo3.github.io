...
function checkWinner() {
    for (let i=0;i<candidates.length;i++) {
        if (candidates[i][1]>0.5) {return candidates[i]}
    }
    return null
}
...
function run() {
    ...
    candidates.forEach((K)=>console.log('  '+K[0]))
    console.log('voters:',ballots.length)
